...
<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'><link rel="stylesheet" href="./lrstyle.css">
...
<div class="input full">
  <label class="string optional" for="user-name2">Name*</label>
                <input class="string optional" maxlength="255" id="user-name" placeholder="Name" type="name" size="50" />
            </div>
<div class="input full">
  <label class="string optional" for="user-name3">Email*</label>
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script><script  src="./lrscript.js"></script>
